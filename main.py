"""Scrape RANS listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other RANS Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=rans&s-original-search=rans",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=rans"),
    ("ASO", "https://aso.com/search?q=Rans"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More RANS Listings</h2>
    <p>View additional Rans Aircraft listings at these fine sites:</p>
